	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition lower_shell = partdefinition.addOrReplaceChild("lower_shell",
				CubeListBuilder.create().texOffs(0, 21)
						.addBox(-8.0F, -4.0F, -8.0F, 16.0F, 4.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(0, 42)
		...
		PartDefinition upper_shell = partdefinition.addOrReplaceChild("upper_shell", CubeListBuilder.create()
				.texOffs(0, 0).addBox(-8.0F, -4.0F, -16.0F, 16.0F, 4.0F, 16.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 20.0F, 8.0F));

		PartDefinition pearl = partdefinition.addOrReplaceChild("pearl", CubeListBuilder.create().texOffs(29, 42)
