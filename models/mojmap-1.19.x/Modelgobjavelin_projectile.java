	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition javelin = partdefinition.addOrReplaceChild("javelin",
				CubeListBuilder.create().texOffs(0, 0)
						...
						.addBox(-0.5F, 0.5F, -2.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(11, 4)
						...
						.addBox(-0.5F, -9.5F, -1.0F, 1.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-0.5F, 2.5F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 14.5F, 0.0F, 0.0F, -1.5708F, 3.1416F));
