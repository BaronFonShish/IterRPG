...
public class Modelfleshmite<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "fleshmite"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition front = Mob.addOrReplaceChild("front", CubeListBuilder.create().texOffs(16, 12).addBox(-3.0F,
				-3.0F, -2.0F, 6.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -3.0F, -2.0F));

		PartDefinition upper_jaw = front.addOrReplaceChild("upper_jaw", CubeListBuilder.create().texOffs(0, 20).addBox(
				-2.0F, -1.0F, -3.0F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, -2.0F));

		PartDefinition bottom_jaw = front.addOrReplaceChild("bottom_jaw", CubeListBuilder.create().texOffs(14, 20)
				.addBox(-2.0F, -2.0F, -3.0F, 4.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 3.0F, -2.0F));

		PartDefinition middle = front.addOrReplaceChild("middle", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F,
				-3.5F, 0.0F, 8.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.5F, 0.0F));

		PartDefinition end = middle.addOrReplaceChild("end",
				CubeListBuilder.create().texOffs(0, 12)
						.addBox(-3.0F, -3.0F, 0.0F, 6.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(21, 0)
						.addBox(-2.0F, 0.0F, 2.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
