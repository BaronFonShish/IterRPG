...
public class ModelScab<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition mob = partdefinition.addOrReplaceChild("mob", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-5.0F, -8.0F, -6.0F, 10.0F, 6.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition tail = mob.addOrReplaceChild("tail",
				CubeListBuilder.create().texOffs(0, 11)
						.addBox(0.0F, -17.0F, -5.0F, 0.0F, 17.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(0, 40)
						.addBox(-2.0F, -3.0F, -1.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -7.0F, 5.0F));

		PartDefinition stinger = tail.addOrReplaceChild("stinger", CubeListBuilder.create().texOffs(24, 11).addBox(0.0F,
				-2.0F, -11.0F, 0.0F, 11.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -15.0F, -5.0F));

		PartDefinition front_right_leg = mob.addOrReplaceChild("front_right_leg", CubeListBuilder.create(),
				PartPose.offset(-5.0F, -3.0F, -3.0F));

		PartDefinition claw_r1 = front_right_leg
				.addOrReplaceChild("claw_r1",
						CubeListBuilder.create().texOffs(32, 7).addBox(-8.0F, -2.0F, 0.0F, 8.0F, 5.0F, 0.0F,
		...
		PartDefinition claw_r2 = front_left_leg
				.addOrReplaceChild("claw_r2",
						CubeListBuilder.create().texOffs(0, 18).addBox(0.0F, -2.0F, 0.0F, 8.0F, 5.0F, 0.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.4363F, 0.0F));
		...
		PartDefinition claw_r3 = hind_right_leg
				.addOrReplaceChild("claw_r3",
						CubeListBuilder.create().texOffs(16, 18).addBox(-8.0F, -2.0F, 0.0F, 8.0F, 5.0F, 0.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.4363F, 0.0F));
		...
		PartDefinition claw_r4 = hind_left_leg
				.addOrReplaceChild("claw_r4",
						CubeListBuilder.create().texOffs(32, 18).addBox(0.0F, -2.0F, 0.0F, 8.0F, 5.0F, 0.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.4363F, 0.0F));

		PartDefinition left_claw = mob.addOrReplaceChild("left_claw", CubeListBuilder.create().texOffs(33, 0).addBox(
				-3.0F, -1.0F, -6.0F, 4.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, -2.1F, -6.0F));

		PartDefinition right_claw = mob.addOrReplaceChild("right_claw", CubeListBuilder.create().texOffs(25, 0)
				.addBox(-1.0F, -1.0F, -6.0F, 4.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-4.0F, -2.1F, -6.0F));
