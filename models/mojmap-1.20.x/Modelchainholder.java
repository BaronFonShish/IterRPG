...
public class Modelchainholder<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "chainholder"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition base = partdefinition
				.addOrReplaceChild("base",
						CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, -5.0F, -6.0F, 12.0F, 5.0F, 12.0F,
		...
		PartDefinition chain = partdefinition.addOrReplaceChild("chain", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 21.0F, 2.0F, 0.7854F, 0.0F, 0.0F));

		PartDefinition segment1 = chain.addOrReplaceChild("segment1", CubeListBuilder.create(),
		...
		PartDefinition right_r1 = segment1.addOrReplaceChild("right_r1",
				CubeListBuilder.create().texOffs(32, 17)
						.addBox(-2.0F, 5.0F, -4.0F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(36, 0)
						.addBox(-2.0F, -8.0F, -4.0F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition right_r2 = segment1.addOrReplaceChild("right_r2",
				CubeListBuilder.create().texOffs(32, 17)
						.addBox(-2.0F, 5.0F, -4.0F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 17)
						.addBox(-2.0F, 3.0F, -4.0F, 4.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(16, 19)
						.addBox(-2.0F, -5.0F, -4.0F, 4.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(36, 0)
						.addBox(-2.0F, -8.0F, -4.0F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 27)
						.addBox(1.0F, -5.0F, -2.0F, 3.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(14, 29)
						.addBox(-4.0F, -5.0F, -2.0F, 3.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.7854F, 0.0F));

		PartDefinition segment2 = chain.addOrReplaceChild("segment2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -24.0F, 0.0F, 0.0F, 0.7854F, 0.0F));
		...
		PartDefinition segment3 = chain.addOrReplaceChild("segment3", CubeListBuilder.create(),
