...
public class Modelrevenant_gore<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "revenant_gore"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition horn_r1 = head.addOrReplaceChild("horn_r1",
				CubeListBuilder.create().texOffs(34, 15).mirror()
						.addBox(-1.0F, -4.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(3.0F, -6.0F, 2.0F, -0.9599F, 0.0F, 0.7418F));

		PartDefinition horn_r2 = head.addOrReplaceChild("horn_r2",
				CubeListBuilder.create().texOffs(34, 15).addBox(-1.0F, -5.0F, -1.0F, 2.0F, 6.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -7.0F, -2.0F, -0.5236F, 0.0F, -0.5236F));

		PartDefinition horn_r3 = head.addOrReplaceChild("horn_r3",
				CubeListBuilder.create().texOffs(34, 15).mirror()
						.addBox(-1.0F, -5.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(3.0F, -7.0F, -2.0F, -0.5236F, 0.0F, 0.5236F));

		PartDefinition horn_r4 = head.addOrReplaceChild("horn_r4",
				CubeListBuilder.create().texOffs(34, 15).addBox(-1.0F, -4.0F, -1.0F, 2.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -6.0F, 2.0F, -0.9599F, 0.0F, -0.7418F));
		...
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm",
				CubeListBuilder.create().texOffs(33, 0).mirror()
						...
						.texOffs(42, 0).mirror().addBox(-2.0F, 5.0F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.1F))
						.mirror(false),
				PartPose.offset(-5.0F, 1.0F, 0.0F));

		PartDefinition claw_r1 = right_arm.addOrReplaceChild("claw_r1",
				CubeListBuilder.create().texOffs(43, 10).mirror()
						.addBox(-1.0F, -3.0F, 0.25F, 3.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-1.5F, 11.0F, 0.75F, 0.0F, -0.0873F, 0.0F));

		PartDefinition claw_r2 = right_arm.addOrReplaceChild("claw_r2",
				CubeListBuilder.create().texOffs(43, 10).mirror()
						.addBox(-1.0F, -3.0F, -0.25F, 3.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-1.5F, 11.0F, -0.75F, 0.0F, 0.0873F, 0.0F));
		...
		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(32, 30).mirror()
						.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(5.0F, 1.0F, 0.0F));
