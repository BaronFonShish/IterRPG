...
public class SpellRecallItem extends Item {
	public SpellRecallItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("iterpg.spell.recall"));
		...
		list.add(Component.translatable("iterpg.spell.mana.50"));
		list.add(Component.translatable("iterpg.spell.desc.recall"));
	}
}
