...
public class SpellEmbersItem extends Item {
	public SpellEmbersItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("iterpg.spell.embers"));
		...
		list.add(Component.translatable("iterpg.spell.desc.embers"));
	}
}
