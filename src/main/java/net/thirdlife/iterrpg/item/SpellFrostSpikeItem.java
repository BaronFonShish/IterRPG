...
public class SpellFrostSpikeItem extends Item {
	public SpellFrostSpikeItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("iterpg.spell.frost_spike"));
		...
		list.add(Component.translatable("iterpg.spell.desc.frost_spike"));
	}
}
