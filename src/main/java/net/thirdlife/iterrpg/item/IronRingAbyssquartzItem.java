...
public class IronRingAbyssquartzItem extends Item implements ICurioItem {
	public IronRingAbyssquartzItem() {
	...
	public ItemStack getCraftingRemainingItem(ItemStack itemstack) {
		return new ItemStack(IterRpgModItems.IRON_RING.get());
	}
