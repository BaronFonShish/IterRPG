...
public class EarthBoulderEntity extends Monster {
	public static final EntityDataAccessor<Boolean> DATA_death = SynchedEntityData.defineId(EarthBoulderEntity.class, EntityDataSerializers.BOOLEAN);

	public EarthBoulderEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(IterRpgModEntities.EARTH_BOULDER.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(DATA_death, false);
	}
	...
	public void baseTick() {
		super.baseTick();
		EarthBoulderTickProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
