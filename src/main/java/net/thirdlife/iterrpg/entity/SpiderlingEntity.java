...
public class SpiderlingEntity extends Monster {
	public SpiderlingEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(IterRpgModEntities.SPIDERLING.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(IterRpgModEntities.SPIDERLING.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
