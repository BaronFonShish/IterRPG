...
public class FleshmiteEntity extends Monster {
	public FleshmiteEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(IterRpgModEntities.FLESHMITE.get(), world);
	}

	public FleshmiteEntity(EntityType<FleshmiteEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 1;
		setNoAi(false);
