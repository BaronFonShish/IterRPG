...
public class AuraSummonFireProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (dospawn == true) {
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = IterRpgModEntities.AURA_SOULFIRE.get().spawn(_level, BlockPos.containing(auraposx, ycheck, auraposz), MobSpawnType.MOB_SUMMONED);
