...
public class ZapHomingProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity immediatesourceentity) {
		...
		if (immediatesourceentity.getPersistentData().getDouble("lifetime") > lifetime) {
			if (world instanceof ServerLevel _level)
				_level.sendParticles((SimpleParticleType) (IterRpgModParticleTypes.LIGHTNING_PARTICLE.get()), x, (y - 0.15), z, 8, 0.25, 0.25, 0.25, 0.05);
		...
		if (world instanceof ServerLevel _level)
			_level.sendParticles((SimpleParticleType) (IterRpgModParticleTypes.LIGHTNING_PARTICLE.get()), x, y, z, 2, 0.05, 0.05, 0.05, 0);
	}
}
