...
import net.thirdlife.iterrpg.common.procedures.SkyArmorJumpProcedure;
...
public class JumpKeybindMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			SkyArmorJumpProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		IterRpgMod.addNetworkMessage(JumpKeybindMessage.class, JumpKeybindMessage::buffer, JumpKeybindMessage::new, JumpKeybindMessage::handler);
	}
}
