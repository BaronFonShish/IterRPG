...
public class ArcanistTableGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ArcanistTableGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
