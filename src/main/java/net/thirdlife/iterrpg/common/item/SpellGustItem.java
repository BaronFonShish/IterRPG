...
public class SpellGustItem extends Item {
	public SpellGustItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("iterpg.spell.gust"));
		...
		list.add(Component.translatable("iterpg.spell.desc.gust"));
	}
}
