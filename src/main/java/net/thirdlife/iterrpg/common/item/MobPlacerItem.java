...
import net.thirdlife.iterrpg.common.procedures.MobPlacerActivateProcedure;
import net.thirdlife.iterrpg.common.item.inventory.MobPlacerInventoryCapability;
...
public class MobPlacerItem extends Item {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Mob Placer");
				}
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		MobPlacerActivateProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getItemInHand());
