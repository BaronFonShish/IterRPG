...
import net.thirdlife.iterrpg.common.procedures.HarvestStrikeProcedure;
...
public class HarvestItem extends SwordItem {
	public HarvestItem() {
		super(new Tier() {
			public int getUses() {
				return 2048;
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		HarvestStrikeProcedure.execute(entity.level(), entity.getX(), entity.getY(), entity.getZ(), entity, sourceentity);
		return retval;
	}
