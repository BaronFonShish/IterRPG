...
import net.thirdlife.iterrpg.common.procedures.CoinTimerTickProcedure;
...
public class GoblinWarriorEntity extends Monster {
	public GoblinWarriorEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(IterRpgModEntities.GOBLIN_WARRIOR.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(4, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				double x = GoblinWarriorEntity.this.getX();
				double y = GoblinWarriorEntity.this.getY();
				double z = GoblinWarriorEntity.this.getZ();
				Entity entity = GoblinWarriorEntity.this;
				Level world = GoblinWarriorEntity.this.level();
