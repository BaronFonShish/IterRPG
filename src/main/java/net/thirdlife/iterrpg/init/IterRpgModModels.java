...
import net.thirdlife.iterrpg.client.model.Modelchainholder;
...
public class IterRpgModModels {
	...
	public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
		...
		event.registerLayerDefinition(Modelflamebolt.LAYER_LOCATION, Modelflamebolt::createBodyLayer);
		...
		event.registerLayerDefinition(Modelchainholder.LAYER_LOCATION, Modelchainholder::createBodyLayer);
