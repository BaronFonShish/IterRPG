...
public class IterRpgModBrewingRecipes implements IModPlugin {
	...
	public void registerRecipes(IRecipeRegistration registration) {
		...
		inputStack.clear();
		ingredientStack.clear();
		ingredientStack.add(new ItemStack(Items.BLACK_DYE));
		PotionUtils.setPotion(potion, Potions.WATER);
		brewingRecipes.add(factory.createBrewingRecipe(List.copyOf(ingredientStack), potion.copy(), new ItemStack(IterRpgModItems.INK_BOTTLE.get())));
		ingredientStack.clear();
		ingredientStack.add(new ItemStack(IterRpgModItems.GIST.get()));
		inputStack.add(new ItemStack(IterRpgModItems.ETHERBLOOM_DECOCTION.get()));
		brewingRecipes.add(factory.createBrewingRecipe(List.copyOf(ingredientStack), List.copyOf(inputStack), new ItemStack(IterRpgModItems.ETHERBREW.get())));
		inputStack.clear();
		ingredientStack.clear();
