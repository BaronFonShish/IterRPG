...
public class IterRpgModTabs {
	...
	public static final RegistryObject<CreativeModeTab> ITER_MAGIC = REGISTRY.register("iter_magic",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.iter_rpg.iter_magic")).icon(() -> new ItemStack(IterRpgModItems.SPELL_ETHERBOLT.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(IterRpgModItems.SPELL_SCRIBBLES.get());
				...
				tabData.accept(IterRpgModItems.SPELL_RECALL.get());
				tabData.accept(IterRpgModItems.SPELL_MEND.get());
				...
				tabData.accept(IterRpgModItems.SPELL_FROST_SPIKE.get());
	...
	public static void buildTabContentsVanilla(BuildCreativeModeTabContentsEvent tabData) {
		if (tabData.getTabKey() == CreativeModeTabs.BUILDING_BLOCKS) {
			...
			tabData.accept(IterRpgModBlocks.SANGUARNET_BLOCK.get().asItem());
			...
			tabData.accept(IterRpgModBlocks.FLESH_WEAVER.get().asItem());
		} else if (tabData.getTabKey() == CreativeModeTabs.REDSTONE_BLOCKS) {
			tabData.accept(IterRpgModBlocks.DRILL.get().asItem());
			tabData.accept(IterRpgModBlocks.CRUNCHER.get().asItem());
			...
			tabData.accept(IterRpgModBlocks.PEBBLE_LAUNCHER.get().asItem());
			...
			tabData.accept(IterRpgModItems.EARTH_SWORD.get());
			tabData.accept(IterRpgModItems.EARTH_DAGGER.get());
			tabData.accept(IterRpgModItems.EARTH_SCYTHE.get());
			tabData.accept(IterRpgModItems.EARTH_SPEAR.get());
			tabData.accept(IterRpgModItems.EARTH_FLAIL.get());
			tabData.accept(IterRpgModItems.WATER_SWORD.get());
			tabData.accept(IterRpgModItems.WATER_DAGGER.get());
			tabData.accept(IterRpgModItems.WATER_SCYTHE.get());
			tabData.accept(IterRpgModItems.WATER_SPEAR.get());
			tabData.accept(IterRpgModItems.WATER_FLAIL.get());
			tabData.accept(IterRpgModItems.AIR_SWORD.get());
			tabData.accept(IterRpgModItems.AIR_DAGGER.get());
			tabData.accept(IterRpgModItems.AIR_SCYTHE.get());
			tabData.accept(IterRpgModItems.AIR_SPEAR.get());
			tabData.accept(IterRpgModItems.AIR_FLAIL.get());
			tabData.accept(IterRpgModItems.FIRE_SWORD.get());
			tabData.accept(IterRpgModItems.FIRE_DAGGER.get());
			tabData.accept(IterRpgModItems.FIRE_SCYTHE.get());
			tabData.accept(IterRpgModItems.FIRE_SPEAR.get());
			tabData.accept(IterRpgModItems.FIRE_FLAIL.get());
			tabData.accept(IterRpgModItems.VOID_SWORD.get());
			tabData.accept(IterRpgModItems.VOID_DAGGER.get());
			tabData.accept(IterRpgModItems.VOID_SCYTHE.get());
			tabData.accept(IterRpgModItems.VOID_SPEAR.get());
			tabData.accept(IterRpgModItems.VOID_FLAIL.get());
			tabData.accept(IterRpgModItems.SWORD_OF_BOUNDING.get());
			tabData.accept(IterRpgModItems.BLOODLETTER.get());
			...
			tabData.accept(IterRpgModItems.RECURVE_BOW.get());
			...
			tabData.accept(IterRpgModItems.FIRESTARTER.get());
			...
			tabData.accept(IterRpgModItems.AZURE_HELMET.get());
			tabData.accept(IterRpgModItems.AZURE_CHESTPLATE.get());
			tabData.accept(IterRpgModItems.AZURE_LEGGINGS.get());
			tabData.accept(IterRpgModItems.AZURE_BOOTS.get());
			...
			tabData.accept(IterRpgModItems.EARTH_ARMOR_HELMET.get());
			tabData.accept(IterRpgModItems.EARTH_ARMOR_CHESTPLATE.get());
			tabData.accept(IterRpgModItems.EARTH_ARMOR_LEGGINGS.get());
			tabData.accept(IterRpgModItems.EARTH_ARMOR_BOOTS.get());
			tabData.accept(IterRpgModItems.WATER_ARMOR_HELMET.get());
			tabData.accept(IterRpgModItems.WATER_ARMOR_CHESTPLATE.get());
			tabData.accept(IterRpgModItems.WATER_ARMOR_LEGGINGS.get());
			tabData.accept(IterRpgModItems.WATER_ARMOR_BOOTS.get());
			tabData.accept(IterRpgModItems.AIR_ARMOR_HELMET.get());
			tabData.accept(IterRpgModItems.AIR_ARMOR_CHESTPLATE.get());
			tabData.accept(IterRpgModItems.AIR_ARMOR_LEGGINGS.get());
			tabData.accept(IterRpgModItems.AIR_ARMOR_BOOTS.get());
			tabData.accept(IterRpgModItems.FIRE_ARMOR_HELMET.get());
			tabData.accept(IterRpgModItems.FIRE_ARMOR_CHESTPLATE.get());
			tabData.accept(IterRpgModItems.FIRE_ARMOR_LEGGINGS.get());
			tabData.accept(IterRpgModItems.FIRE_ARMOR_BOOTS.get());
			tabData.accept(IterRpgModItems.VOID_ARMOR_HELMET.get());
			tabData.accept(IterRpgModItems.VOID_ARMOR_CHESTPLATE.get());
			tabData.accept(IterRpgModItems.VOID_ARMOR_LEGGINGS.get());
			tabData.accept(IterRpgModItems.VOID_ARMOR_BOOTS.get());
			...
			tabData.accept(IterRpgModItems.ANCIENT_KNOWLEDGE.get());
			tabData.accept(IterRpgModItems.FESTERING_WINGS.get());
			tabData.accept(IterRpgModItems.IRON_RING.get());
			tabData.accept(IterRpgModItems.GOLD_RING.get());
			tabData.accept(IterRpgModItems.NETHERITE_RING.get());
			tabData.accept(IterRpgModItems.IRON_RING_AMETHYST.get());
			tabData.accept(IterRpgModItems.GOLD_RING_AMETHYST.get());
			tabData.accept(IterRpgModItems.NETHERITE_RING_AMETHYST.get());
			tabData.accept(IterRpgModItems.IRON_RING_DIAMOND.get());
			tabData.accept(IterRpgModItems.GOLD_RING_DIAMOND.get());
			tabData.accept(IterRpgModItems.NETHERITE_RING_DIAMOND.get());
			tabData.accept(IterRpgModItems.IRON_RING_ABYSSQUARTZ.get());
			tabData.accept(IterRpgModItems.GOLD_RING_ABYSSQUARTZ.get());
			tabData.accept(IterRpgModItems.NETHERITE_RING_ABYSSQUARTZ.get());
			tabData.accept(IterRpgModItems.IRON_RING_MAGMANUM.get());
			tabData.accept(IterRpgModItems.GOLD_RING_MAGMANUM.get());
			tabData.accept(IterRpgModItems.NETHERITE_RING_MAGMANUM.get());
			tabData.accept(IterRpgModItems.IRON_RING_EMERALD.get());
			tabData.accept(IterRpgModItems.GOLD_RING_EMERALD.get());
			tabData.accept(IterRpgModItems.NETHERITE_RING_EMERALD.get());
			tabData.accept(IterRpgModItems.IRON_RING_SANGUARNET.get());
			tabData.accept(IterRpgModItems.GOLD_RING_SANGUARNET.get());
			tabData.accept(IterRpgModItems.NETHERITE_RING_SANGUARNET.get());
			tabData.accept(IterRpgModItems.THE_ROCK.get());
			tabData.accept(IterRpgModItems.DAMNED_HELMET.get());
			tabData.accept(IterRpgModItems.DAMNED_CHESTPLATE.get());
			tabData.accept(IterRpgModItems.DAMNED_LEGGINGS.get());
			tabData.accept(IterRpgModItems.DAMNED_BOOTS.get());
			...
			tabData.accept(IterRpgModItems.FLESHMITE_SPAWN_EGG.get());
			...
			tabData.accept(IterRpgModItems.AXEBEAK_SPAWN_EGG.get());
			...
			tabData.accept(IterRpgModItems.PRIMORDIAL_INGOT.get());
			tabData.accept(IterRpgModItems.PRIMORDIAL_FRAGMENT.get());
			...
			tabData.accept(IterRpgModItems.DWARVEN_COMPONENTS.get());
			tabData.accept(IterRpgModItems.COG_HEART.get());
			...
			tabData.accept(IterRpgModItems.SANGUARNET.get());
			tabData.accept(IterRpgModItems.AWAKENED_SANGUARNET.get());
			...
			tabData.accept(IterRpgModItems.RING_MOULD.get());
			tabData.accept(IterRpgModItems.FLAWLESS_DIAMOND.get());
			tabData.accept(IterRpgModItems.FLAWLESS_EMERALD.get());
			tabData.accept(IterRpgModItems.FLAWLESS_MAGMANUM.get());
			tabData.accept(IterRpgModItems.BOWSTRING.get());
			tabData.accept(IterRpgModItems.AXEBEAK_FEATHER.get());
			...
			tabData.accept(IterRpgModBlocks.SANGUARNET_ORE.get().asItem());
			tabData.accept(IterRpgModBlocks.COMPONENT_DEPOSIT.get().asItem());
			...
			tabData.accept(IterRpgModBlocks.FLESH_BLOCK.get().asItem());
			tabData.accept(IterRpgModBlocks.THEWS_BLOCK.get().asItem());
			tabData.accept(IterRpgModBlocks.TENDONS_BLOCK.get().asItem());
			tabData.accept(IterRpgModBlocks.BLOODROOT.get().asItem());
			tabData.accept(IterRpgModBlocks.NEURAL_APPENDAGE.get().asItem());
			tabData.accept(IterRpgModBlocks.TALL_NEURAL_APPENDAGE.get().asItem());
			tabData.accept(IterRpgModBlocks.GLOWCYST.get().asItem());
			tabData.accept(IterRpgModBlocks.TALL_GLOWCYST.get().asItem());
			tabData.accept(IterRpgModBlocks.NEURAL_FERN.get().asItem());
			tabData.accept(IterRpgModBlocks.DEVILTHORN.get().asItem());
			tabData.accept(IterRpgModBlocks.DEMONBONES.get().asItem());
			tabData.accept(IterRpgModBlocks.DEMON_FANGS.get().asItem());
			...
			tabData.accept(IterRpgModItems.ETHERBREW.get());
			tabData.accept(IterRpgModItems.AXEBEAK_MEAT.get());
			...
			tabData.accept(IterRpgModItems.EARTH_PICKAXE.get());
			tabData.accept(IterRpgModItems.EARTH_AXE.get());
			tabData.accept(IterRpgModItems.EARTH_SHOVEL.get());
			tabData.accept(IterRpgModItems.EARTH_HOE.get());
			tabData.accept(IterRpgModItems.WATER_PICKAXE.get());
			tabData.accept(IterRpgModItems.WATER_AXE.get());
			tabData.accept(IterRpgModItems.WATER_SHOVEL.get());
			tabData.accept(IterRpgModItems.WATER_HOE.get());
			tabData.accept(IterRpgModItems.AIR_PICKAXE.get());
			tabData.accept(IterRpgModItems.AIR_AXE.get());
			tabData.accept(IterRpgModItems.AIR_SHOVEL.get());
			tabData.accept(IterRpgModItems.AIR_HOE.get());
			tabData.accept(IterRpgModItems.FIRE_PICKAXE.get());
			tabData.accept(IterRpgModItems.FIRE_AXE.get());
			tabData.accept(IterRpgModItems.FIRE_SHOVEL.get());
			tabData.accept(IterRpgModItems.FIRE_HOE.get());
			tabData.accept(IterRpgModItems.VOID_PICKAXE.get());
			tabData.accept(IterRpgModItems.VOID_AXE.get());
			tabData.accept(IterRpgModItems.VOID_SHOVEL.get());
			tabData.accept(IterRpgModItems.VOID_HOE.get());
		}
	}
}
