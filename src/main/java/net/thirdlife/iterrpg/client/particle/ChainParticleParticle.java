...
public class ChainParticleParticle extends TextureSheetParticle {
	public static ChainParticleParticleProvider provider(SpriteSet spriteSet) {
		return new ChainParticleParticleProvider(spriteSet);
	}
	...
	public static class ChainParticleParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			ChainParticleParticle particle = new ChainParticleParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			return particle;
		}
	}
