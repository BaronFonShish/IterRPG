...
public class ElementalDropletParticle extends TextureSheetParticle {
	public static ElementalDropletParticleProvider provider(SpriteSet spriteSet) {
		return new ElementalDropletParticleProvider(spriteSet);
	}
	...
	public static class ElementalDropletParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			ElementalDropletParticle particle = new ElementalDropletParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			return particle;
		}
	}
