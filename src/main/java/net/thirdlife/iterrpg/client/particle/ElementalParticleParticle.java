...
public class ElementalParticleParticle extends TextureSheetParticle {
	public static ElementalParticleParticleProvider provider(SpriteSet spriteSet) {
		return new ElementalParticleParticleProvider(spriteSet);
	}
	...
	public static class ElementalParticleParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			ElementalParticleParticle particle = new ElementalParticleParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			return particle;
		}
	}
