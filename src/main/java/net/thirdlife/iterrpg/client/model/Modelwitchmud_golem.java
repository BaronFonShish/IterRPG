...
public class Modelwitchmud_golem<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition plamt_r1 = body.addOrReplaceChild("plamt_r1", CubeListBuilder.create().texOffs(1, 22).mirror().addBox(0.0F, -8.5F, -6.5F, 0.0F, 17.0F, 13.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, -27.5F, 0.0F, 0.0F, -0.7854F, 0.0F));
		PartDefinition plamt_r2 = body.addOrReplaceChild("plamt_r2", CubeListBuilder.create().texOffs(34, 22).addBox(0.0F, -8.5F, -6.5F, 0.0F, 17.0F, 13.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -27.5F, 0.0F, 0.0F, 0.7854F, 0.0F));
