...
public class Modelgreat_bubble<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("iter_rpg", "modelgreat_bubble"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bubble = partdefinition.addOrReplaceChild("bubble", CubeListBuilder.create().texOffs(0, 0).addBox(-7.5F, -7.5F, -7.5F, 15.0F, 15.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 16.5F, 0.0F));
