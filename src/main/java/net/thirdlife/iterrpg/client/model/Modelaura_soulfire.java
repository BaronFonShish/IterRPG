...
public class Modelaura_soulfire<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("iter_rpg", "modelaura_soulfire"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition aura = partdefinition.addOrReplaceChild("aura", CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, 0.0F, -8.0F, 16.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 23.75F, 0.0F));
