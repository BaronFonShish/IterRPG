...
public class Modelflamebolt<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("iter_rpg", "modelflamebolt"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition projectile = partdefinition.addOrReplaceChild("projectile",
				CubeListBuilder.create().texOffs(8, 11).addBox(-2.0F, -1.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(-1.5F, 1.0F, -1.5F, 3.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)),
