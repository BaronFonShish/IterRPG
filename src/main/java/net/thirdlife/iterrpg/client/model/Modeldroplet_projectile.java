...
public class Modeldroplet_projectile<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("iter_rpg", "modeldroplet_projectile"), "main");
	public final ModelPart droplet;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition droplet = partdefinition.addOrReplaceChild("droplet",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -3.25F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 6).addBox(-1.0F, -0.25F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
